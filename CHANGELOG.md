...
* Fix `vertical_whitespace_between_cases` false positives when one-line cases are
  separated only by comments.  
  [leno23](https://github.com/leno23)
  [#6412](https://github.com/realm/SwiftLint/issues/6412)
