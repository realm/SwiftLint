...
* Fix `baseline compare` incorrectly reporting some violations
  as new, and also sorts the violations from `baseline compare`
  deterministically.  
  [Martin Redington](https://github.com/mildm8nnered)
...
* Add configuration option to exclude specific attribute names from redundant_optional_initialization rule.  
  [ShubhamDindorkar](https://github.com/ShubhamDindorkar)
