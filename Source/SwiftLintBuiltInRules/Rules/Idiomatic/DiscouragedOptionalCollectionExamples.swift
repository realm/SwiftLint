internal struct DiscouragedOptionalCollectionExamples {
    ...
    static let triggeringExamples = [
        ...
        Example("let foo = ↓Optional.some([Int]())"),
        Example("let foo = ↓Optional.some([String: String]())"),
        Example("let foo = ↓Optional.some(Set<Int>())"),
        ...
        // Optional chaining
        Example("_ = ↓[Int]?.values()"),
        Example("_ = ↓[String: String]?.values()"),
        Example("_ = ↓Set<Int>?.values()")
    ]
}
