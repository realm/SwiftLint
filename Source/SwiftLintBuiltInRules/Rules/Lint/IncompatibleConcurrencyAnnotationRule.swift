...
struct IncompatibleConcurrencyAnnotationRule: Rule {
    ...
    static let description = RuleDescription(
        ...
        kind: .lint,
        minSwiftVersion: .six,
        nonTriggeringExamples: IncompatibleConcurrencyRuleExamples.nonTriggeringExamples,
        triggeringExamples: IncompatibleConcurrencyRuleExamples.triggeringExamples,
        corrections: IncompatibleConcurrencyRuleExamples.corrections
    )
}
