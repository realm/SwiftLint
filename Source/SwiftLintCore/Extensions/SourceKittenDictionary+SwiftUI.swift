...
public struct SwiftUIModifier {
    ...
    public struct Argument {
        ...
        public init(name: String, required: Bool = true, values: [String], matchType: MatchType = .exactMatch) {
            self.name = name
    ...
    public enum MatchType {
        ...
        public func matches(argumentValue: String, targetValue: String) -> Bool {
            switch self {
            case .prefix:
