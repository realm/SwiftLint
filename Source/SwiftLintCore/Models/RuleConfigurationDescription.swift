...
extension OptionType {
  ...
  public static func => (key: String, value: OptionType) -> RuleConfigurationOption {
...
extension AcceptableByConfigurationElement {
  public func asDescription(with key: String) -> RuleConfigurationDescription {
...
///
@propertyWrapper
public struct ConfigurationElement<T: AcceptableByConfigurationElement & Equatable & Sendable>:
  Equatable, Sendable
{
...
extension AcceptableByConfigurationElement where Self: RuleConfiguration {
  ...
  public mutating func apply(_ value: Any, ruleID _: String) throws {
    try apply(configuration: value)
  }

  public init(fromAny _: Any, context _: String) throws {
