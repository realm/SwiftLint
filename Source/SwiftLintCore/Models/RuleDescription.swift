...
public struct RuleDescription: Equatable, Sendable {
    ...
    /// - parameter nonTriggeringExamples: Sets the description's `nonTriggeringExamples` property. Use the `#examples([...])` macro to turn an array of strings into an array of `Example`s.
    /// - parameter triggeringExamples:    Sets the description's `triggeringExamples` property. Use the `#examples([...])` macro to turn an array of strings into an array of `Example`s.
    /// - parameter corrections:           Sets the description's `corrections` property. Use the `#examplesDictionary([...])` macro to turn a `[String: String]` dictionary into an `[Example: Example]` dictionary.
