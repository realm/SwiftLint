...
public let masterRuleList = RuleList(rules:
    ...
    FileHeaderRule.self,
    FileLengthRule.self,
    FirebaseConfigActivateRule.self,
    FirebaseConfigDefaultsRule.self,
    FirebaseConfigFetchRule.self,
    FirebaseCoreRule.self,
    FirebaseDynamicLinksCustomSchemeURLRule.self,
    FirebaseDynamicLinksUniversalLinkRule.self,
    FirebaseDynamicLinksSchemeURLRule.self,
    FirebaseInvitesRule.self,
    FirstWhereRule.self,
    ForceCastRule.self,
    ForceTryRule.self,
