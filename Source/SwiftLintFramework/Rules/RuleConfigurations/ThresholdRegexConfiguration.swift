...
public struct ThresholdRegexConfiguration: RuleConfiguration, Hashable, CacheDescriptionProvider {
    ...
    public var thresholdCount: Int = 1
    ...
    public mutating func apply(configuration: Any) throws {
        ...
        if let threshold = configurationDict["threshold"] as? Int {
            self.thresholdCount = threshold
        }
