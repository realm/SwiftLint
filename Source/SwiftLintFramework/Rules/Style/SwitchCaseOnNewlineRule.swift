...
public struct SwitchCaseOnNewlineRule: ASTRule, ConfigurationProviderRule, OptInRule, AutomaticTestableRule {
    ...
    public static let description = RuleDescription(
        ...
        nonTriggeringExamples: [
            ...
            wrapInSwitch("//case 1:\n return true"),
            wrapInSwitch("let x = [caseKey: value]"),
            wrapInSwitch("let x = [key: .default]"),
            wrapInSwitch("if case let .someEnum(value) = aFunction([key: 2]) { }"),
            wrapInSwitch("guard case let .someEnum(value) = aFunction([key: 2]) { }"),
            wrapInSwitch("for case let .someEnum(value) = aFunction([key: 2]) { }"),
            wrapInSwitch("enum Environment {\n case development\n}"),
