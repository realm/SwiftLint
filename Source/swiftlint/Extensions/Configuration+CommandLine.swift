...
extension Configuration {
    ...
    init(options: LintOrAnalyzeOptions) {
        ...
        self.init(childConfigQueue: options.configurationFiles, rootPath: type(of: self).rootPath(from: options.paths),
    ...
    init(options: RulesOptions) {
        self.init(childConfigQueue: options.configurationFiles, rootPath: nil, optional: isConfigOptional())
    }
}
