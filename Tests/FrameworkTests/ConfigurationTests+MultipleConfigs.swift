...
extension ConfigurationTests {
    ...
    func level2() {
        ...
        #expect(
            config == Constants.Config._0.merged(withChild: config2, rootDirectory: config.rootDirectory)
        )
    }
    ...
    func level3() {
        ...
        #expect(
            config == Constants.Config._0.merged(withChild: config3, rootDirectory: config.rootDirectory)
        )
    }
    ...
    func nestedConfigurationForOnePathPassedIn() {
        ...
        #expect(
            config.configuration(for: SwiftLintFile(path: Constants.Swift._3)!) == config
        )
    }
    ...
    func validChildConfig() {
        for path in [Constants.Dir.childConfigTest1, Constants.Dir.childConfigTest2] {
    ...
    @Test
    func validParentConfig() {
        for path in [Constants.Dir.parentConfigTest1, Constants.Dir.parentConfigTest2] {
            #expect(FileManager.default.changeCurrentDirectoryPath(path))
    ...
    func configCycleDetection() {
        for path in [
            ...
            #expect(
                Configuration(configurationFiles: []) == Configuration()
            )
        }
    }
    ...
    func commandLineConfigsCycleDetection() {
        #expect(FileManager.default.changeCurrentDirectoryPath(Constants.Dir.childConfigCycle4))
    ...
    func validRemoteChildConfig() {
        #expect(FileManager.default.changeCurrentDirectoryPath(Constants.Dir.remoteConfigChild))
    ...
    func validRemoteParentConfig() {
        #expect(FileManager.default.changeCurrentDirectoryPath(Constants.Dir.remoteConfigParent))
    ...
    func sRemoteConfigNotAllowedToReferenceLocalConfig() {
        #expect(FileManager.default.changeCurrentDirectoryPath(Constants.Dir.remoteConfigLocalRef))
    ...
    func remoteConfigCycleDetection() {
        #expect(FileManager.default.changeCurrentDirectoryPath(Constants.Dir.remoteConfigCycle))
