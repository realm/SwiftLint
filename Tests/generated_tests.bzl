...
def generated_tests(copts, strict_concurrency_copts):
    ...
    Args:
        ...
        strict_concurrency_copts: Strict concurrency compiler options
    """
    _generated_test_shard("1", copts, strict_concurrency_copts)
    _generated_test_shard("2", copts, strict_concurrency_copts)
    _generated_test_shard("3", copts, strict_concurrency_copts)
    _generated_test_shard("4", copts, strict_concurrency_copts)
    _generated_test_shard("5", copts, strict_concurrency_copts)
    _generated_test_shard("6", copts, strict_concurrency_copts)
    _generated_test_shard("7", copts, strict_concurrency_copts)
    _generated_test_shard("8", copts, strict_concurrency_copts)
    _generated_test_shard("9", copts, strict_concurrency_copts)
