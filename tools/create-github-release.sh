...
gh release create "$version" --title "$release_title" -F "$release_notes" --draft --verify-tag  \
    ...
    "swiftlint-windows-amd64.zip#AMD64 Windows Binary"                                          \
    "swiftlint-windows-arm64.zip#ARM64 Windows Binary"                                          \
    "swiftlint-windows-amd64.msi#AMD64 Windows Installer"                                       \
    "swiftlint-windows-arm64.msi#ARM64 Windows Installer"                                       \
